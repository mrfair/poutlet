...
module.exports = function () {
  ...
  (async function() {
    ...
    if(fs.existsSync(path.resolve('poutlet_build/poutlet_root/http2_middleware.js')) === true) {
      http2_middleware = require(path.resolve('poutlet_build/poutlet_root/http2_middleware.js'));
    }
