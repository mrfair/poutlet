...
module.exports = function (mode) {
  ...
  var _header_cache_control = {"Cache-Control":
  "no-cache"};
  if(mode === 'build') { 
  ...
  try {
      ...
      if (
        ...
        fs.readdirSync(folder_path).forEach((file_name) => {
          if(fs.lstatSync(`${folder_path}/${file_name}`).isDirectory() === true) {
            ...
            if(_static_path !== '') _static_path = _static_path + '/';
    ...
    if (
      ...
      fs.readdirSync(_root_folder_path + "/method").forEach((method_name) => {
        ...
        var _poutlet_plugin_now_method = _poutlet_plugin["/_*"].method[
          method_name.toLowerCase()
        ];

        if(!_poutlet_plugin_now_method) _poutlet_plugin_now_method = {};
        ...
        if (
          ...
          if (
            ...
            _poutlet_plugin_now_method["/"].headers = {
              ..._header_cache_control
            };
            ...
            if (
              ...
              _poutlet_plugin_now_method["/"].css =
                fs.readFileSync(
                  `${_root_folder_path}/method/${method_name}/root.css`,
                  {
                    encoding: "utf8",
              ...
              (method_name) => {
                ...
                var read_path_to_plugin = function (path_dir, prefix_name) {
                  ...
                  fs.readdirSync(path_dir).forEach((file_name) => {
                    //Static folder
                    if(file_name === 'checkpoint.js') {
                      _checkpoint = require(`${path_dir}/${file_name}`);
                  ...
                  ..._header_cache_control
                    ...
                    //Not include to route
                    else if (file_name[0] === '_') {
                    ...
                    //file
                      ...
                      mime.lookup(file_name) === "application/javascript"
                        ...
                        _poutlet_plugin_now_method[
                          ...
                          if(typeof _checkpoint === 'function') {
                            await _checkpoint(request, response);
                          }
