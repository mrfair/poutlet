...
module.exports = function() {
  ...
  if(fs.existsSync(path.resolve('poutlet_root')) !== true) {
    ...
    fs.writeFileSync(path.resolve('poutlet_root/get/root.js'), `module.exports = function(request, response) { response.html(\`<i class="fas fa-smile-wink"></i> Hi world. I'm Poutlet.\`); return; };`);
